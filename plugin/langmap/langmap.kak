...
toggle-langmap -params ..1 %{ evaluate-commands -client %val{client} %sh{
    ...
    perl $kak_opt_langmap_root/langmap.pl $map_mode $kak_opt_langmap_default $kak_opt_langmap | kak -p $kak_session
}}
...
langmap-display-layout -params 2 %{ evaluate-commands %sh{
    # $kak_client
    perl $kak_opt_langmap_root/display_layout.pl $@ | kak -p $kak_session
}}
